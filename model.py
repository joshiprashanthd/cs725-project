...
from tensorflow.python.keras.layers import Conv2D, Dropout, BatchNormalization, LeakyReLU, Conv2DTranspose as Deconv2D, Activation, Concatenate, Multiply
...
def unet(inputs=Input((512, 128, 1))):
    ...
    output = Multiply()([maskConv, inputs])
